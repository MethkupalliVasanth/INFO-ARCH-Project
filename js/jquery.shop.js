			...
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var html = "<div class='detail'>";
						...
						html += "<ul>";
						html += "<li>" + "Shipping Name :"+ name + "</li>";
						html += "<li>" + "Shipping Email Id :"+ email + "</li>";
						
						html += "<li>" + "Shipping Address1 :"+ address + "</li>";
						html += "<li>" + "Shipping City :"+ city + "</li>";
						html += "<li>" + "Shipping Zip Code :"+ zip + "</li>";
						html += "<li>" + "Shipping Country :"+ country + "</li>";
						html += "</ul></div>";
