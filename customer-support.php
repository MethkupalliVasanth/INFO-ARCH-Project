           ...
           <div class="aa-contact-address">
             <div class="row">
               <div class="col-md-8">
				 ...
				 <br><br><br>
                   <p>To Access the Customer Support Form</p><br><br>
				   <a style="font-size:20px;color:blue" href="form.html"><strong>Click Here</strong></a>
               ...
               <div class="col-md-4">
                 <div class="aa-contact-address-right">
				   ...
				   <br><br><br>
                     <h4>StayBeautiful</h4>
                     <p></p>
                     <p><span class="fa fa-home"></span>107 S Indiana Ave, Bloomington, IN 47405</p><br>
                     <p><span class="fa fa-phone"></span>Ph: +1 812-349-8724</p><br>
