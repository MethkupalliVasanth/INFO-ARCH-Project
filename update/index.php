                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <ul class="aa-footer-nav">
                      ...
                      <p><a href="customer-support.php">Customer Support</a></p>
              ...
              <div class="col-md-12">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h4>Contact Us</h4>
                    <address>
                      <h4> 804 N Woodbridge Drive, Bloomington, IN 47408</h4>
                      <h4><span class="fa fa-phone"></span>+1 812-955-1456</h4>
                      <h4><span class="fa fa-envelope"></span>bhaveshxvera@gmail.com</h4>
                    </address>
