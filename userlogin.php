                        ...
                        <div class="col-md-5 col-md-offset-4">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form id="login-form" method="post"  action="uservalid.php" role="form">
									...
									<?php } ?>
										...
										<a href="regis.php"><span class="glyphicon glyphicon-plus"></span>Registration</a>
										</button>
										
										<button type="button" class="btn btn-lg btn-success btn-primary btn-block btn-default btn-info">
										<a href="forgotpassword.php"><span class="glyphicon glyphicon-plus"></span>Forgot Password</a>
										</button>								
				                    </form>
			                    </div>
		                    </div>
